    ...
    <>
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex h-20 items-center justify-between px-8">
          <div>
            <h1 className="text-xl font-bold text-black">Esterometro XML</h1>
            <p className="text-gray-700">Upload your invoices</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 p-6 space-y-6">
        <div className="flex flex-row gap-4">
          {/* Panel 1: Amazon PDFs */}
          <UploadPanel
            title="Upload Amazon Invoices PDF"
          ...
          <UploadPanel
            title="Upload all other invoices PDF"
