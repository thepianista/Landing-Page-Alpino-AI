              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl">
                    Your comprehensive platform for social media automation and business intelligence. Manage your
                    LinkedIn presence and grow your professional network effortlessly.
                  </p>
                </div>
